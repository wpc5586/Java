package com.aaron.aaronworld.emchat.api;
...
public interface ChatGroupAPI {
	 ...
	 *            用户ID或用户名，数组形式
	 * @return
	 * @see com.aaron.aaronworld.emchat.comm.body.UserNamesBody
	 */
	 ...
	 *            新群主ID或用户名
	 * @return
     * @see com.aaron.aaronworld.emchat.comm.body.GroupOwnerTransferBody
	 */
